...
section .data
    ...
    compile_cmd_template: db "nasm -f elf64 -g %1$s -o %2$s && ld -lc -dynamic-linker /lib64/ld-linux-x86-64.so.2 -g %2$s -o %3$s && rm %2$s", 0
